...
Tabs.prototype.setup = function () {
  ...
  $module.querySelector('.govuk-tabs__list').setAttribute('role', 'tablist')
  $module.querySelector('.govuk-tabs__list-item').setAttribute('role', 'presentation')
...
Tabs.prototype.teardown = function () {
  ...
  $module.querySelector('.govuk-tabs__list').removeAttribute('role')
  $module.querySelector('.govuk-tabs__list-item').removeAttribute('role')

  nodeListForEach($tabs, function ($tab) {
    // Remove events
    $tab.removeEventListener('click', this.onTabClick, false)
    $tab.removeEventListener('keydown', this.onTabKeydown, false)
